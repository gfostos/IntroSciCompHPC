...
int main(int argc, char **argv) {
    ...
    const int N = atoi(argv[2]); // Dimension of the matrices, try larger values like 512 or 1024 to see performance difference
    const int BLOCK_SIZE = atoi(argv[3]); // Dimension of the blocks
...
//parallel './a_O{1}.out 10 1024 {2} >> out_O{1}.txt' ::: 0 1 2 3 fast ::: $(seq 32 64 1024)
//parallel 'g++ -O{} matmulblock.cpp -o a_O{}.out' ::: 0 1 2 3 fast